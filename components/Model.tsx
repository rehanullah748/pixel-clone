...
const Model = () => {
  ...
  return model ? (
    <div className='fixed p-6 inset-0 w-full h-full bg-black/35 backdrop-blur flex justify-center items-center '>
      ...
      <div className='relative overflow-y-scroll w-[1200px] h-[730px] mt-[50px] bg-[#FFFFFF]  rounded-lg  py-[120px]'>
        
      <div className=' flex justify-between items-center px-5 -mt-[40px]'>
      ...
      <div>
        ...
        <div className='mt-9'>
        <Image className='mx-auto rounded-sm'  src={imageDetails?.webformatURL} alt='image details' width={800} height={700}/>
        </div>
